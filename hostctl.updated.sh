...
# Description: Wait for background apt/dpkg processes to release locks
###############################################################################
wait_for_apt() {
...
# Description: Report whether the system indicates that a reboot is required
###############################################################################
...
# Description: Optionally install and configure UFW baseline firewall rules
###############################################################################
configure_ufw() {
